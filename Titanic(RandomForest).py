...
alg = RandomForest
Classifier(random_state=1, n_estimators=150, min_samples_split=4, min_samples_leaf=2)
...
submission.to_csv("/Users/shubhityagi/Downloads/kaggle(RandomForest).csv", index=False)
